...
# Vault PKI integration commented out — using OpenShift edge TLS termination instead.
# The VaultPKISecret full chain causes Java keystore validation failures in Keycloak.
# TODO: revisit if end-to-end TLS (passthrough) is needed in the future.
